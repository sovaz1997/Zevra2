...
const double K = 150;
const int PARAMS_COUNT = 12 * 64 + 2 * (28 + 15 + 14 + 8) + 8 * 2 + 21;
...
void setValues(int *values) {
    ...
    transfer(&values[curIndex], QueenMobilityEG, &curIndex, 28);
    transfer(&values[curIndex], RookMobility, &curIndex, 15);
    transfer(&values[curIndex], RookMobilityEG, &curIndex, 15);
    transfer(&values[curIndex], BishopMobility, &curIndex, 14);
    transfer(&values[curIndex], BishopMobilityEG, &curIndex, 14);
    transfer(&values[curIndex], KnightMobility, &curIndex, 8);
    transfer(&values[curIndex], KnightMobilityEG, &curIndex, 8);

    transfer(&values[curIndex], PassedPawnBonus, &curIndex, 8);
    transfer(&values[curIndex], PassedPawnBonusEG, &curIndex, 8);

    transfer(&values[curIndex], &DoublePawnsPenalty, &curIndex, 1);
    transfer(&values[curIndex], &DoublePawnsPenaltyEG, &curIndex, 1);
    ...
    transfer(&values[curIndex], &RookOnPartOpenFileBonusEG, &curIndex, 1);
...
int *getValues() {
    ...
    transfer(QueenMobilityEG, &res[curIndex], &curIndex, 28);
    transfer(RookMobility, &res[curIndex], &curIndex, 15);
    transfer(RookMobilityEG, &res[curIndex], &curIndex, 15);
    transfer(BishopMobility, &res[curIndex], &curIndex, 14);
    transfer(BishopMobilityEG, &res[curIndex], &curIndex, 14);
    transfer(KnightMobility, &res[curIndex], &curIndex, 8);
    transfer(KnightMobilityEG, &res[curIndex], &curIndex, 8);

    transfer(PassedPawnBonus, &res[curIndex], &curIndex, 8);
    transfer(PassedPawnBonusEG, &res[curIndex], &curIndex, 8);

    transfer(&DoublePawnsPenalty, &res[curIndex], &curIndex, 1);
    transfer(&DoublePawnsPenaltyEG, &res[curIndex], &curIndex, 1);
